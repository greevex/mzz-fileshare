...
(function($) {
    ...
    $.fn.activebar.defaults = {
        ...
        'fontColor': 'InfoText',
        'fontSize': '11px',
        'icons_path' : '/public/images/icons/',
        'url': 'http://www.microsoft.com/rus/windows/internet-explorer/default.aspx',
        'preload': true
    };
...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Internet Explorer не хватает обновлений, необходимых для просмотра этого сайта. Нажмите здесь, чтобы обновить ...')
