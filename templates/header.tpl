...
<head>
	...
	<script type="text/javascript" src="{$SITE_PATH}/templates/js/slide.js"></script>
	<![endif]-->
	<!--[if IE 7]>
	{literal}<style type="text/css">#middleline{top:110px}#legal1,#legal2{bottom:-2px;}#footer{position:fixed;width:100%;}</style>{/literal}
	<![endif]-->
...
<!--[if IE]><div id="vertical_slide" class="vertical_slide"><span id="attention" class="attention">Настоятельно рекомендуется сменить Ваш обозреватель на один из следующих: <a target="_blank" href="http://mozilla.ru">Mozilla Firefox</a>, <a target="_blank" href="http://opera.com">Opera</a>, <a target="_blank" href="http://chrome.google.com">Google Chrome</a>.</span><span id="closetip"></span></div><![endif]-->
</body>
</html>
<!--
{$smarty.const.MZZ_NAME} v.{$smarty.const.MZZ_VERSION}-{$smarty.const.MZZ_REVISION} &copy; {"Y"|date}.
{$timer->toString()}
-->