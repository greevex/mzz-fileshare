...
define('DEBUG_MODE', 1);
define('SYSTEM_PATH', realpath(dirname(__FILE__) . '/../../../greens1.servehttp.com/engine/system/'));
...
systemConfig::$db['default']['dsn']  = 'mysql:host=localhost;dbname=dobrin';
systemConfig::$db['default']['user'] = 'dobrin';
systemConfig::$db['default']['password'] = 'dobrin';
